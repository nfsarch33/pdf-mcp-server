...
- [ ] Remote LLM behavior is fail-closed unless explicitly opted in
...
- [ ] `USAGE.md` regenerated if registry/tool surface changed

## Manual verification

Describe how you verified by invoking the CLI and/or MCP tools and re-reading outputs.
